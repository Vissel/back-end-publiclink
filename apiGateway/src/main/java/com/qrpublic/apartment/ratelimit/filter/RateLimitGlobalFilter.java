package com.qrpublic.apartment.ratelimit.filter;
...
import com.qrpublic.apartment.ratelimit.resolver.KeyResolver;
import com.qrpublic.apartment.ratelimit.service.RateLimiterService;
...
public class RateLimitGlobalFilter implements GlobalFilter, Ordered {
    ...
    public RateLimitGlobalFilter(RateLimitProperties rateLimitProperties) {
    ...
    private RateLimitPolicy resolvePolicyForPath(String requestPath) {
        ...
        return rateLimitProperties.getPolicies().stream()
                ...
                .map(pc -> RateLimitPolicy.builder()
                        ...
                        .refillToken(pc.getRefillTokens())
